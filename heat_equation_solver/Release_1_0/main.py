...
# y_0 = Y0()
# y_gamma = Ygamma()
p, b, u_0, u_gamma = solve(y_0, y_gamma)
y_0_expr = y_0.integrate_in_cube(y_0.green * u_0, [x_, y_, t_], [0, 0, -10], [1, 1, 0], 3)
y_gamma_expr = y_gamma.integrate_in_cube(y_gamma.green * u_gamma, [x_, y_, t_], [-10, -10, 0], [10, 10, 1], 3) \
               - y_gamma.integrate_in_cube(y_gamma.green * u_gamma, [x_, y_, t_], [0, 0, 0], [1, 1, 1], 2)
